...
public interface GenericDao<T, PK extends Serializable> {
    ...
    /**
	 * Creates and executes hibernate query from provided HQL query and parameters. You can use either numbered parameters or named parameters, 
	 * but not both in the same query.
	 * @param query HQL query.
	 * @param parameters Map with parameters. Number from 0.
	 * @return List of found objects.
	 */
    List<T> find(String query, Map<Object, Object> parameters);
